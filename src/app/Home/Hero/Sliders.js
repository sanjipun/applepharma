  ...
  const [heroSliders, setheroSliders] = useState([
    {
      id: "slider1",
      bgImg: HeroImage3,
      title: "Setting New Healthcare <br> Standards",
      subTitle: "For better health, better life...",
      subAnotherTitle:
        "A <span> WHO-GMP </span> Certified, Medicine manufactorinf Company.",
      button: {
        text: "About Us",
        link: "/about",
      },
    ...
    },
    {
      id: "slider2",
      bgImg: HeroImage2,
      title: "Quality Medicine for <br> Improved Lives",
      subTitle: "For better health, better life...",
      subAnotherTitle:
        "A <span> WHO-GMP </span> Certified, Medicine manufactorinf Company.",
      button: {
        ...
        >
          {heroSliders.map((singleSlider) => (
            ...
            >
              ...
              <div
                className="container"
                style={{ zIndex: "1066", position: "relative" }}
              >
